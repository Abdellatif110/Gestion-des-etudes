        ...
        {(['work', 'shortBreak', 'longBreak'] as const).map((mode) => (
          <Button
            ...
            className={cn(
              ...
              currentMode === mode && mode === 'work' && "bg-timer-work hover:bg-timer-work/90",
              currentMode === mode && mode === 'shortBreak' && "bg-timer-break hover:bg-timer-break/90",
              currentMode === mode && mode === 'longBreak' && "bg-timer-longBreak hover:bg-timer-longBreak/90"
            )}
          >
